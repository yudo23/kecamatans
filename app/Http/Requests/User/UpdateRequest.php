...
class UpdateRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'email' => [
                ...
                'string',
                'max:255',
                Rule::unique('users')->ignore(request()->route()->parameter('id')),
            ],
            'name' => [
                'required',
            ],
            'phone' => [
                ...
                'numeric',
                'min:8',
                Rule::unique('users','phone')->ignore(request()->route()->parameter('id')),
            ],
            'roles' => [
                'required',
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'province_code.exists' => 'Provinsi tidak ditemukan',
            'agency_id.required' => 'Dinas tidak boleh kosong',
            'agency_id.exists' => 'Dinas tidak ditemukan',
        ];
    }

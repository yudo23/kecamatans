...
class ServiceController extends Controller
{
    ...
    {
        $response = $this->serviceService->index($request);
    ...
    {
        try {
            $response = $this->serviceService->store($request);
            if (!$response->success) {
    ...
    {
        try {
            $response = $this->serviceService->update($request, $id);
            if (!$response->success) {
                return ResponseHelper::apiResponse(false, $response->message , null, null, $response->code);
            }
    ...
    {
        try {
            $response = $this->serviceService->delete($id);
            if (!$response->success) {

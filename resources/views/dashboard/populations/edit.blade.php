...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('dashboard.populations.update',$result->id)}}" id="frmUpdate">
                    @csrf
                    @method("PUT")
                    <div class="form-group row mb-3">
                        <label class="col-md-2 col-form-label">Jumlah Penduduk <span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <input type="number" class="form-control" name="name" placeholder="Jumlah Penduduk" value="{{old('name',$result->name)}}">
                        </div>
                    </div>
                    <div class="form-group row mb-3">

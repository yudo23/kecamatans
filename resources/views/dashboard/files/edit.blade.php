...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('dashboard.files.update',$result->id)}}" id="frmUpdate">
                    @csrf
                    @method("PUT")
                    <div class="form-group row mb-3">
                        <label class="col-md-2 col-form-label">Nama File <span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name" placeholder="Nama File" value="{{old('name',$result->name)}}">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="{{route('dashboard.files.index')}}" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
                ...
                $.ajax({
                    ...
                    success : function(resp){
                        if(resp.success == false){
                            ...
                            responseSuccess(resp.message,"{{route('dashboard.files.index')}}");
                        }
                    },

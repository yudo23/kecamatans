...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('dashboard.potentials.update',$result->id)}}" id="frmUpdate">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name" placeholder="Nama Potensi Desa" value="{{old('name',$result->name)}}">
                        </div>
                    </div>
                    <div class="form-group row mb-3">

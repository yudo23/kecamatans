    ...
    <div class="col-md-12">
        <div class="card m-b-30 px-3">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <a href="{{route('dashboard.galleries.create')}}" class="btn btn-primary btn-sm btn-add"><i class="fa fa-plus"></i> Tambah</a>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="{{route('dashboard.galleries.show',$row->id)}}" class="dropdown-item"><i class="fa fa-eye"></i> Show</a>
                                                    <a href="{{route('dashboard.galleries.edit',$row->id)}}" class="dropdown-item"><i class="fa fa-edit"></i> Edit</a>
...
@include("dashboard.galleries.modal.index")
    ...
    $(function() {
        ...
        $(document).on("click", ".btn-delete", function() {
            ...
            if (confirm("Apakah anda yakin ingin menghapus data ini ?")) {
                $("#frmDelete").attr("action", "{{ route('dashboard.galleries.destroy', '_id_') }}".replace("_id_", id));

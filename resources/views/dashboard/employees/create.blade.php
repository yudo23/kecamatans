...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('dashboard.employees.store')}}" id="frmStore">
                    @csrf
                    <div class="form-group row mb-3">
                        <label class="col-md-2 col-form-label">Nama Pegawai <span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name" placeholder="Nama Pegawai" value="{{old('name')}}">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        <label class="col-md-2 col-form-label">Foto Pegawai <span class="text-danger">*</span></label>
                        <div class="col-md-10">
